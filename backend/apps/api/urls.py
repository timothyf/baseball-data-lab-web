...
urlpatterns = [
    ...
    path('players/career_stats/', player_career_stats_batch, name='api-player-career-stats'),
    ...
    path('players/halloffame/', hall_of_fame_players, name='api-hall-of-fame-search'),
